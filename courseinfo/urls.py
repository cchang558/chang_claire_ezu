...
from courseinfo.views import (
    InstructorList, InstructorDetail, InstructorCreate, InstructorUpdate, InstructorDelete,
    SectionList, SectionDetail, SectionCreate, SectionUpdate, SectionDelete,
    CourseList, CourseDetail, CourseCreate, CourseUpdate, CourseDelete,
    SemesterList, SemesterDetail, SemesterCreate, SemesterUpdate, SemesterDelete,
    StudentList, StudentDetail, StudentCreate, StudentUpdate, StudentDelete,
    RegistrationList, RegistrationDetail, RegistrationCreate, RegistrationUpdate, RegistrationDelete,
)
