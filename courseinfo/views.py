...
from courseinfo.forms import (
    InstructorForm, SectionForm, CourseForm, SemesterForm, StudentForm, RegistrationForm,
)
from courseinfo.models import (
    Instructor, Section, Course, Semester, Student, Registration,
)
...
class InstructorDetail(LoginRequiredMixin, PermissionRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['section_list'] = instructor.sections.all()
        return context
